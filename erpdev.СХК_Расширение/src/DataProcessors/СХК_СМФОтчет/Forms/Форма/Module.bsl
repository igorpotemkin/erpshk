...
Функция НаборПродаж()
	...
	ЗапросКом.Текст = "ВЫБРАТЬ РАЗЛИЧНЫЕ
	                  ...
	                  |	СУММА(ОтчетКомиссионераТовары.КоличествоУпаковок) КАК КоличествоУпаковок,
	                  |	СУММА(ОтчетКомиссионераТовары.СуммаПродажи - ОтчетКомиссионераТовары.СуммаПродажиНДС) КАК Выручка,
	                  ...
	                  |	СУММА(ВТЗ.Выручка) КАК Выручка,
	                  |	СУММА(ВТЗ.КоличествоУпаковок) КАК КоличествоУпаковок,
	                  |	ВТЗ.Контрагент КАК Контрагент
	                  |ПОМЕСТИТЬ ВТЗРасчет
	                  |ИЗ
	                  |	ВТЗ КАК ВТЗ
	                  |ГДЕ
	                  |	ВТЗ.КоличествоУпаковок <> 0
	                  |	И ВТЗ.Выручка <> 0
	                  |
	                  |СГРУППИРОВАТЬ ПО
	                  |	ВТЗ.Номенклатура,
	                  ...
	                  |////////////////////////////////////////////////////////////////////////////////
	                  |ВЫБРАТЬ
	                  |	ВТЗРасчет.Номенклатура КАК Номенклатура,
	                  |	ВТЗРасчет.Контрагент КАК Контрагент,
	                  |	ВТЗРасчет.Выручка / ВТЗРасчет.КоличествоУпаковок КАК Цена
	                  |ИЗ
	                  |	ВТЗРасчет КАК ВТЗРасчет";
